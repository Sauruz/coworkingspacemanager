<div class="wrap">
    ...
    <ul class="nav nav-tabs">
        ...
        <li class="active"><a href="?page=csm-edit-member&member_identifier=<?php echo $data['identifier'];?>"><i class="fa fa-fw fa-user" aria-hidden="true"></i> Profile of <?php echo $data['first_name'];?></a></li>
    </ul>
