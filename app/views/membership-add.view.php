<div class="wrap" ng-app="App" ng-controller="Ctrl as Ctrl">
    <h1 class="wp-heading-inline"><strong><?php echo __('New Membership', 'csm');?></strong></h1>
                    ...
                    <div class="panel">
                        <div class="panel-body">
                            <form action="" method="post" membership-add>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <label for="user_id"><?php echo __('Member', 'csm');?> <span class="description">(required)</span></label><br>
                                        <select class="form-control" id="user_id" name="user_id" ng-model="vm.selectedMember">
                                            <option value=""> -- <?php echo __('Select a member', 'csm');?> -- </option>
