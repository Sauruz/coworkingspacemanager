<?php
/**
 * Administration API: WP_List_Table_Custom class
 *
 * @package WordPress
...
<?php
	...
	/**
	 * Public wrapper for WP_List_Table_Custom::get_default_primary_column_name().
	 *
	 * @since 4.4.0
	 * @access public
	 *
	...
	protected function get_primary_column_name() {
		...
		if ( ! isset( $columns[ $default ] ) ) {
			$default = WP_List_Table_Custom::get_default_primary_column_name();
		}
...
<?php
	...
	/**
	 * Get a list of CSS classes for the WP_List_Table_Custom table tag.
	 *
	 * @since 3.1.0
	 * @access protected
	 *
