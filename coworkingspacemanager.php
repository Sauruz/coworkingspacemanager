...
function csm_menu() {
    ...
    add_submenu_page( 'coworking-space-manager', 'All Members', 'All Members', 'manage_options', 'coworking-space-manager');
    add_submenu_page( 'coworking-space-manager', 'Add Member', 'Add Member', 'manage_options', 'csm-add-member', 'show_member_add');
    add_submenu_page( 'coworking-space-manager', 'Subscriptions', 'Subscriptions', 'manage_options', 'csm-subscriptions', 'show_subscriptions');
}